...
public class ZombieConehead extends Zombie {
    ...
    static {
        aAsset_Run = new AnimationAsset("assets/biology/zombie/Zombie4", 21);
        aAsset_Eat = new AnimationAsset("assets/biology/zombie/ConeheadZombieAttack", 11);
    ...
    public ZombieConehead (int rowIndex,ZombieManage manage) {
        super(manage);
        super.blood = 14;
    ...
    public ZombieConehead (int rowIndex,ZombieManage manage,int x) {
        super(manage);
        super.blood = 14;
